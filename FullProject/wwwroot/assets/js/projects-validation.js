...
$(function () {
  ...
  setTimeout(() => {
    ...
    const FormValidation1 = FormValidation.formValidation(document.getElementById('addFullProjectrojectsForm'), {
      fields: { 
        project_name: {
           validators: {
             notEmpty: {
         ...
         program_date: {
          validators: {
            notEmpty: {
              message: 'ادخل تاريخ البدأ'
            },
            date: {
              format: 'YYYY/MM/DD',
              message: 'ادخل صيغة تاريخ'
            },
          }
