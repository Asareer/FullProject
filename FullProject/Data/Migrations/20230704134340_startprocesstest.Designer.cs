...
namespace FullProject.Migrations
{
    ...
    [Migration("20230704134340_startprocesstest")]
    partial class startprocesstest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FullProject.Models.StartProcesses", b =>
                {
                    ...
                    b.ToTable("StartProcesses");

                    b.HasDiscriminator<string>("Discriminator").HasValue("StartProcesses");
                });
            ...
            modelBuilder.Entity("FullProject.Models.Processes2", b =>
                {
                    b.HasBaseType("FullProject.Models.StartProcesses");

                    b.HasDiscriminator().HasValue("Processes2");
                });
            ...
            modelBuilder.Entity("FullProject.Models.Processes3", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("Processes3");
                });
            ...
            modelBuilder.Entity("FullProject.Models.StartActivities", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("StartActivities");
                });
